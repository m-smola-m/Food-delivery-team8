...
VALUES
  ...
  (4017, 'Ресторан "Аппрув"', 'Тестовый ресторан со статусом APPROVED', 'approved@demo.ru', 'auth@approved.ru', '+78001000017', '+78002000017', 'APPROVED', 1017, 2017, 'Пётр Демидов', '+78003000017', 'RESTAURANT', 'pwd17'),
  (4018, 'Кафе "Проверка"', 'Ещё один тестовый ресторан для клиента', 'cafe@check.ru', 'auth@check.ru', '+78001000018', '+78002000018', 'APPROVED', 1018, 2018, 'София Орлова', '+78003000018', 'CAFE', 'pwd18')

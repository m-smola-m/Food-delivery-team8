...
public class OrderRepository {
  ...
  private Order mapResultSetToOrder(ResultSet rs, Connection conn) throws SQLException {
    ...
    order.setTotalPrice(rs.getObject("total_price", Double.class));

    // deliveryAddress в Order это String, а не Address объект
    // Если нужно загрузить адрес из БД, нужно будет изменить модель Order
    // Пока оставляем deliveryAddress как null или пустую строку
